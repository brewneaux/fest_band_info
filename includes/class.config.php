<?PHP
    ...
    class Config
    {
        ...
        private $productionServers = array('/^dev\.env$/');
        ...
        private function production()
        {
            ...
            define('WEB_ROOT', '/simple/');

            $this->dbReadHost      = 'localhost';
            $this->dbWriteHost     = 'localhost';
            $this->dbName          = 'enim_stuff';
            $this->dbReadUsername  = 'enim_dbi';
            $this->dbWriteUsername = 'enim_dbi';
            $this->dbReadPassword  = '123';
            $this->dbWritePassword = '123';
            $this->dbOnError       = '';
